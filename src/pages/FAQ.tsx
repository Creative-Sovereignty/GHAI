...
const faqs = [
  ...
  { q: "How does the Video Editor timeline work?", a: "The timeline features separate tracks for Video, B-Roll, Dialog, Score, and Sound Design. Select a project to auto-populate clips from your generated shots. A built-in preview monitor plays the active clip under the playhead, and transport controls let you play, pause, skip, and scrub in real time. When you're ready, hit Export to render everything into a single MP4." },
];
